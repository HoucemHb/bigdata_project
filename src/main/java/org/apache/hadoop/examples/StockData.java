...
public class StockData {
    ...
    public static class StockDataReducer extends Reducer<Text, DoubleWritable, Text, DoubleWritable> {
        ...
        public void reduce(Text key, Iterable<DoubleWritable> values, Context context)
            ...
            // Debugging: Print the input values for each key
            System.out.println("Key: " + key.toString() + ", Input Values: " + prices.toString());
            ...
            // Calculate the variance (sum of squared differences divided by count)
